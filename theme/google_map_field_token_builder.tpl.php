<?php
  ...
  $js = '
    ...
    function buildToken() {
      mrkrPos = marker.getPosition();
      var latlng = new google.maps.LatLng(mrkrPos);
      latitude = latlng.lat;
      longitude = latlng.lng;
      zoom = map.getZoom();
      width = document.getElementById("width").value;
      height = document.getElementById("height").value;
      document.getElementById("token").value = "[gmf:lat="+latitude+",lon="+longitude+",width="+width+",height="+height+",zoom="+zoom+"]";
    }
  ...
  drupal_add_js($js, 'inline');
	...
	print '<input type="text" id="width" name="width" value="300"/>';
	print '<input type="text" id="height" name="height" value="250"/><br/>';
